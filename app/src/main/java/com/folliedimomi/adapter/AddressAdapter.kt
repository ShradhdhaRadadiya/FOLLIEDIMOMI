...
class AddressAdapter(private val mActivity: Activity, private val myOrderList: List<Addresses>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var mobile2: String = ""
        if (address.phoneMobile.isNotEmpty()) mobile2 = " " + address.phoneMobile

        holder.tvNameTo.text = address.firstname + " " + address.lastname
        holder.tvMobile.text = address.phone + mobile2
        holder.tvAddressOne.text = address.address1

        if (address.address2.isNotEmpty()) holder.tvAddressTwo.text = address.address2
        else holder.tvAddressTwo.hide()

        holder.tvCityToPin.text = address.city + " " + address.postcode + " " + address.country
        ...
        holder.cvAddress.setOnClickListener {
            ...
            myInterface!!.onAddressSelected(address.idAddress.toString())
